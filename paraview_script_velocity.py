...
# set scalar coloring
ColorBy(slice2Display, ('POINTS', 'Velocity', 'Magnitude'))
...
# set scalar coloring
ColorBy(slice3Display, ('POINTS', 'Velocity', 'Magnitude'))
...
# set scalar coloring
ColorBy(slice4Display, ('POINTS', 'Velocity', 'Magnitude'))
...
# set scalar coloring
ColorBy(slice5Display, ('POINTS', 'Velocity', 'Magnitude'))
...
# set scalar coloring
ColorBy(slice6Display, ('POINTS', 'Velocity', 'Magnitude'))
...
# set scalar coloring
ColorBy(slice7Display, ('POINTS', 'Velocity', 'Magnitude'))
...
# set scalar coloring
ColorBy(slice8Display, ('POINTS', 'Velocity', 'Magnitude'))
...
# get color legend/bar for velocityLUT in view renderView8
velocityLUTColorBar = GetScalarBar(velocityLUT, renderView8)

# change scalar bar placement
velocityLUTColorBar.Orientation = 'Horizontal'
velocityLUTColorBar.WindowLocation = 'Any Location'
velocityLUTColorBar.Position = [0.1377914110429446, 0.03145631067961169]
velocityLUTColorBar.ScalarBarLength = 0.7410429447852764
...
slice8Display.RescaleTransferFunctionToDataRange(False, True)
